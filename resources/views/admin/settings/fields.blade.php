<div class="row">
    ...
    <div class="form-group col-sm-12">
        {!! Form::label('setting_dateFormat', 'Date Format:') !!}
        {!! Form::select('setting_dateFormat', $dateFormats, config('settings.dateFormat'), ['class' => 'form-control']) !!}
    </div>
    ...
    <div class="form-group col-sm-12">
        ...
        <a href="{!! route('admin.settings.index') !!}"
           class="btn btn-default btn-flat">{{ trans('l5starter::button.cancel') }}</a>
    </div>
</div>
